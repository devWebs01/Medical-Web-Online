...
$create = function () {
    ...
    medicalRecord::create($validateData);
...
<x-app-layout>
    <x-slot name="title">Tambah medicalRecord Baru</x-slot>
    <x-slot name="header">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Beranda</a></li>
        <li class="breadcrumb-item"><a href="{{ route('medicalRecords.index') }}">medicalRecord</a></li>
        <li class="breadcrumb-item"><a href="#">Tambah medicalRecord</a></li>
    </x-slot>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="alert alert-primary" role="alert">
                        <strong>Tambah medicalRecord</strong>
                        <p>Pada halaman tambah medicalRecord, kamu dapat memasukkan informasi dari medicalRecord baru yang
                            akan disimpan ke
                            sistem.
                        </p>
                    </div>
