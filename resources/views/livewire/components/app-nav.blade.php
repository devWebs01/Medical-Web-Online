    ...
    <div>
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            <ul id="sidebarnav" class="in">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link position-relative" href="{{ route('patients.index') }}" aria-expanded="false">
                        <span>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link position-relative" href="{{ route('medications.index') }}" aria-expanded="false">
                        <span>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link position-relative" href="{{ route('appointments.index') }}"
                        aria-expanded="false">
                        <span>
